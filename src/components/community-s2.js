...
class CommunityS2 extends Component{
    render(){
        return(    
            <Container fluid className="community-s2 d-flex bg-secondary minh-50vh align-items-center py-5 border-top border-secondary">
